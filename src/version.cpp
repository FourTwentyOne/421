...
// Copyright (c) 2014 The 421 developers
...
// for both 421d and 421(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of 421 releases, the client name should be selected from
