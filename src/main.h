...
static const int COINBASE_MATURITY_PPC = 25;
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 2.5 * 60; // 2.5-minute block spacing
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 10; // minimum age for coin age 10 days
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // stake age of full weight 421 days
...
static const uint256 hashGenesisBlockOfficial("0x0000002ac3df61f6e72c368eaf6162f6200d2bc616f2cff2a27c551788216209");
...
public:
    ...
    {
        // 421: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // 421: get transaction coin age
...
public:
    ...
    // 421: block signature - signed by coin base txout[0]'s owner
    ...
    // 421: two types of block: proof-of-work or proof-of-stake
    ...
    // 421: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // 421: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // 421: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // 421: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // 421: block index flags
    enum  
    {
