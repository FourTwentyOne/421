...
static unsigned char pchMessageStartTestOld[4] = { 0xfd, 0xf1, 0xc2, 0xce };
static unsigned char pchMessageStartTestNew[4] = { 0xfe, 0xf2, 0xe0, 0xce };
static unsigned int nMessageStartTestSwitchTime = 1346200000;

// 421 message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xef, 0xed, 0xf4, 0xed };
static unsigned char pchMessageStart421[4] = { 0xe6, 0xd5, 0xc3, 0xdb };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStart421 : pchMessageStartBitcoin, sizeof(pchMessageStart421));
}
