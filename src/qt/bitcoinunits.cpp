...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("421");
    case mBTC: return QString("m421");
    case uBTC: return QString::fromUtf8("μ421");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("421s");
    case mBTC: return QString("Milli-421s (1 / 1,000)");
    case uBTC: return QString("Micro-421s (1 / 1,000,000)");
    default: return QString("???");
    }
}
