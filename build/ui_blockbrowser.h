...
public:
    ...
    void setupUi(QWidget *BlockBrowser)
    {
        ...
        layoutWidget_2->setGeometry(QRect(0, 50, 701, 406));
    ...
    void retranslateUi(QWidget *BlockBrowser)
    {
        ...
        label_5->setText(QApplication::translate("BlockBrowser", "<html><head/><body><p><span style=\" font-size:20px; font-weight:600; color:#006600;\">Block Explorer </span></p></body></html>", 0, QApplication::UnicodeUTF8));
