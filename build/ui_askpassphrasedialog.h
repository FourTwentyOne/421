...
"}"));
        ...
        keyboardToggle = new QToolButton(AskPassphraseDialog);
        keyboardToggle->setObjectName(QString::fromUtf8("keyboardToggle"));

        horizontalLayout->addWidget(keyboardToggle);
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        keyboardToggle->setText(QApplication::translate("AskPassphraseDialog", "Toggle Keyboard", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
